...
function AppViewModel() {
    ...
    this.populateInfoWindow = function(marker, infowindow) {
        if (infowindow.marker != marker) {
            ...
            clientID = "D44ELGFYXEVS5QI0EZT2RWG12PLGA3KKSZO5PIAGLEZJ3JH3";
            clientSecret =
                "ODS0KZ15D5EK4XMBBLSAGVSUJ5M2SGERY4UDOT3TDKF4ES13";
    ...
    this.initMap = function() {
        ...
        var mapOptions = {
            center: new google.maps.LatLng(37.347505, -121.858069),
            zoom: 12,
            styles: styles
        };
